  ...
  <div class="content">
    ...
    <div class="right">
      <div class="topic-info">
        ...
        <div class="t-info">
          <a class="avatar"></a>
          <span class="topic-name" v-if="post.community">{{post.community.community_name}}</span>
        </div>
        <p class="t-desc" v-if="post.community">{{post.community.introduction}}</p>
        <ul class="t-num">
          <li class="t-num-item">
        ...
        <div class="date" v-if="post.community">Created {{$moment(post.community.create_time).format("YYYY-MM-DD HH:mm:ss")}}</div>
